#!/usr/bin/env python3
"""
Auto-converted from train_panoptic_bev_nuscenes.sh
...
# Build the command
cmd = [sys.executable] + ['-m', 'torch.distributed.launch', '--nproc_per_node={NUM', 'GPUs}', '--master_addr={IP', 'ADDR}', '--master_port={PORT', 'NUM}', 'train_panoptic_bev.py', '\\']
