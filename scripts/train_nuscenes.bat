...
:: Generated from train_panoptic_bev_nuscenes.sh
:: ============================================================================
...
echo ========================================
echo PanopticBEV train - nuScenes
echo ========================================
...
set "config_file=%REPO_ROOT%\experiments\config\nuscenes.ini"

:: Run the Python script
python "%REPO_ROOT%\scripts\train_panoptic_bev.py" ^
    --config "%config_file%" ^
    %*
